...
public class MoreUnitAnnotationModel implements IAnnotationModel
{
    ...
    private static final String HAS_TEST = "Test";
        ...
        for (IMethod method : type.getMethods())
        {
            ...
            for (IMethod testMethod : testMethods)
            {
                ...
                for (IAnnotation annotation : allAnnotations)
                {
                    ...
                    else if(HAS_TEST.equals(annotation.getElementName()))
                    {
            ...
            {
                ISourceRange range1 = method.getNameRange();
                System.out.println("Ramesh");
                MoreUnitAnnotation annotation1 = MoreUnitAnnotation.createAnnotationForIgnoredTesMethod(range1);
                System.out.println("Ramesh123");
                synchronized (annotations)
                {
                    annotations.add(annotation1);
                    System.out.println("Ramesh345");
                }
                event.annotationAdded(annotation1);
            }
        }
    }
